...
namespace RiderData
{
    public static class NewRider
    {
        ...
        {
            NewRider.Kart_V1_Cut = 21;
            NewRider.Kart_X_Cut = 109;
            NewRider.Kart_Old_Cut = 318;
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1356 || i == 1357 || i == 1359 || i == 1360 || i == 1364 || i == 1365) //V1
                    {
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 369;
                oPacket.WriteInt(Character - 38 - 43);
                for (short i = 1; i <= Character; i++)//Character
                {
                    if (i == 47 || i == 48 || i == 63 || i == 116 || i == 117 || i == 124 || i == 128 || i == 130 || i == 134 || i == 137 ||
                        ...
                        i == 195 || i == 196 || i == 197 || i == 231 || i == 239 || i == 245 || i == 246 || i == 247 || i == 265 || i == 288 || 
                        i == 333 || i == 334 || i == 335 || i == 336 || i == 337 || i == 338 || i == 339 || i == 350 ||
                        ...
                        i == 304 || i == 310 || i == 311 || i == 312 || i == 313 || i == 340 || i == 341 || i == 342 || i == 343 || i == 344 || 
                        i == 345 || i == 366 || i == 367)
                    {
                    }
                    else
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Pet; i++)
                {
                    if (i == 8 || i == 10 || i == 11 || i == 14 || i == 18 || i == 50 || i == 77 || i == 85 || i == 91 || i == 92 || 
                        i == 105 || i == 107 || i == 120 || i == 136 || i == 156 || i == 158 || i == 159)
                    {
                    }
                    else
                    {
        ...
        public static void FlyingPet()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int FlyingPet = 69;
                oPacket.WriteInt(FlyingPet - 7);
                for (short i = 1; i <= FlyingPet; i++)
                {
                    if (i == 20 || i == 21 || i == 22 || i == 23 || i == 24 || i == 52 || i == 55)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= 1284; i++)
                {
                    if (i == 71 || i == 74 || i == 118 || i == 125 || i == 139 || i == 142 || i == 149 || i == 162 || i == 182 || i == 187 ||
                        ...
                        i == 1271 || i == 1272 || i == 1273 || i == 1274 || i == 1275 || i == 1276)
                    {
                        oPacket.WriteShort(9);
                        oPacket.WriteShort(i);
                        oPacket.WriteShort(0);
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Goggle; i++)
                {
                    if (i == 7 || i == 8 || i == 13 || i == 28 || i == 33 || i == 36 || i == 41 || i == 43 || i == 49 || i == 51 ||
                        ...
                        i == 128 || i == 140 || i == 141 || i == 148 || i == 156 || i == 159 || i == 175 || i == 214)
                    {
                    }
                    else
                    {
        ...
        public static void HeadBand()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HeadBand = 608;
                oPacket.WriteInt(HeadBand + 5 - 48);
                ...
                for (short i = 1; i <= HeadBand; i++)
                {
                    if (i == 16 || i == 21 || i == 23 || i == 29 || i == 37 || i == 39 || i == 40 || i == 41 || i == 43 || i == 44 ||
                        ...
                        i == 503 || i == 506 || i == 527 || i == 529 || i == 531 || i == 551 || i == 577 || i == 607)
                    {
                    }
                    else
                    {
        ...
        public static void HandGearL()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HandGearL = 412;
                oPacket.WriteInt(HandGearL + 6 - 85);
        ...
        public static void MyRoom()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                {
                    if (i == 1 || i == 4 || i == 5 || i == 10 || i == 11 || i == 12 || i == 13 || i == 14 || i == 15 || i == 16 || i == 22 || i == 27 || i == 28 || i == 37)
                    {
                    }
                    else
                    {
