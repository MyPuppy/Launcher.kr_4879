            ...
            lock (this.Parent.m_lock)
			{
                ...
                if ((hash == Adler32Helper.GenerateAdler32(Encoding.ASCII.GetBytes("PcReportRaidOccur"), 0) ? false : hash != 1340475309))
				{
                    ...
                    else if (hash == Adler32Helper.GenerateAdler32_ASCII("PqStartTimeAttack", 0))
                    {
                        ...
                        Console.WriteLine("StartTimeAttack: {0} / {1} / {2} / {3} / {4} / {5} / {6}", StartGameData.StartTimeAttack_SpeedType, StartGameData.StartTimeAttack_GameType, StartGameData.Kart_id, StartGameData.FlyingPet_id, trackName, StartGameData.StartTimeAttack_StartType, StartGameData.StartTimeAttack_RankingTimaAttackType);
                    ...
                    else if (hash == Adler32Helper.GenerateAdler32_ASCII("PqSearchClubListPacket", 0))
                    {
                        ...
                        {
                            outPacket.WriteHexString("0C 00 00 00 3D BB 02 00 05 00 00 00 F5 AC 75 C7 D1 C9 69 D5 8C C1 05 96 00 00 00 FF FF FF FF BA 52 9A 00 00 09 3D 00 01 00 00 00 06 00 00 00 0C C0 55 CB B1 BE 45 D2 45 AC 35 B0 09 00 00 00 7A AD 19 50 13 00 00 00 E0 C2 80 AC 20 00 34 00 09 AE 20 00 10 D3 15 C8 20 00 78 C7 9D C9 20 00 C4 D6 20 00 00 AC 85 C7 20 00 00 AC A5 B2 00 05 C1 BC 63 00 47 00 02 00 05 00 00 00 4C AE 74 B9 98 D3 14 B5 E0 C5 05 78 00 00 00 FF FF FF FF A3 C0 00 00 C0 C6 2D 00 52 01 00 00 06 00 00 00 00 B3 5C D4 C1 B9 98 D3 14 B5 E0 C5 24 00 00 00 5C AB 45 33 6D 00 00 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 04 D6 AC C7 20 00 C0 C9 08 AE 20 00 74 C7 20 00 1C C2 04 AC 44 C7 20 00 90 C9 A8 AC 7C B7 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 5B 00 20 00 74 D0 FD B7 20 00 74 CE 98 D3 20 00 3A 00 20 00 68 00 74 00 74 00 70 00 73 00 3A 00 2F 00 2F 00 63 00 61 00 66 00 65 00 2E 00 6E 00 61 00 76 00 65 00 72 00 2E 00 63 00 6F 00 6D 00 2F 00 63 00 70 00 64 00 67 00 20 00 5D 00 00 04 CF E2 2D 00 C8 09 01 00 07 00 00 00 43 00 61 00 6D 00 65 00 6C 00 69 00 61 00 05 78 00 00 00 FF FF FF FF A0 EB 00 00 C0 C6 2D 00 66 01 00 00 0C 00 00 00 43 00 61 00 6D 00 65 00 6C 00 69 00 61 00 48 00 65 00 69 00 7A 00 65 00 42 00 00 00 17 AA EA 51 1F 00 00 00 20 00 5B 00 20 00 74 CE A1 D1 20 00 24 C6 08 D5 44 CC 05 D3 20 00 43 00 61 00 6D 00 65 00 6C 00 69 00 61 00 20 00 00 AC 85 C7 38 BB 58 C7 20 00 A4 C2 4F D5 26 00 44 C5 5C D1 20 00 5D 00 00 04 D8 27 1F 00 95 05 00 00 0B 00 00 00 43 00 6F 00 6E 00 71 00 75 00 65 00 72 00 54 00 65 00 61 00 6D 00 05 96 00 00 00 FF FF FF FF AD 7A 00 00 00 09 3D 00 19 01 00 00 0C 00 00 00 43 00 6F 00 6E 00 71 00 75 00 65 00 72 00 42 00 4C 00 61 00 63 00 6B 00 40 00 00 00 D0 A9 B1 4E 24 00 00 00 20 00 68 00 74 00 74 00 70 00 
 2F 00 73 00 72 00 7A 00 69 00 77 00 4D 00 77 00 62 00 20 00 20 00 55 00 6E 00 4C 00 69 00 6D 00 69 00 74 00 20 00 00 AC 85 C7 38 BB 58 C7 20 00 3A 00 20 00 68 00 74 00 74 00 70 00 3A 00 2F 00 2F 00 70 00 66 00 2E 00 6B 00 61 00 6B 00 61 00 6F 00 2E 00 63 00 6F 00 6D 00 2F 00 5F 00 69 00 47 00 78 00 6E 00 78 00 71 00 4B 00 2F 00 63 00 68 00 61 00 74 00 00 04 A4 35 0D 00 1C 17 00 00 04 00 00 00 52 00 69 00 63 00 68 00 05 96 00 00 00 FF FF FF FF A1 1D 00 00 00 09 3D 00 18 01 00 00 03 00 00 00 5A 00 31 00 58 CE 12 00 00 00 FB A9 4E 2A 77 00 00 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 32 00 30 00 32 00 31 00 2E 00 30 00 37 00 2E 00 32 00 38 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 52 00 69 00 63 00 68 00 20 00 74 D0 FD B7 D0 C6 20 00 A8 BA D1 C9 11 C9 5B 00 24 C6 08 D5 44 CC 05 D3 20 00 3A 00 20 00 74 CE B8 D2 7C B7 74 C7 54 B3 20 00 52 00 69 00 63 00 68 00 5D 00 00 05 71 F2 0C 00 E9 05 00 00 09 00 00 00 41 00 70 00 70 00 6C 00 65 00 54 00 65 00 61 00 6D 00 05 78 00 00 00 FF FF FF FF 08 25 00 00 C0 C6 2D 00 50 01 00 00 0B 00 00 00 41 00 70 00 70 00 6C 00 65 00 4C 00 65 00 61 00 64 00 65 00 72 00 3E 00 00 00 D0 A9 B1 4E 83 00 00 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 41 00 70 00 70 00 6C 00 65 00 54 00 65 00 61 00 6D 00 20 00 32 00 30 00 31 00 32 00 2D 00 30 00 32 00 2D 00 30 00 35 00 20 00 20 00 20 00 20 00 31 00 32 00 2F 00 31 00 33 00 20 00 35 00 19 B8 20 00 EC B2 31 C1 21 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 5F D1 4C 00 31 00 18 C2 00 C9 20 00 38 BB 58 C7 20 00 3A 00 20 00 74 CE 74 CE 24 C6 A1 D1 20 00 60 C5 0C D5 4C D1 A4 C2 B8 D2 29 BC 20 00 26 00 20 00 74 CE 74 CE 24 C6 44 CC 10 B1 20 00 41 00 70 00 70 00 6C 00 65 00 54 00 65 00 61 00 6D 00 20 00 21 00 21 00 21 00 21 00 20 00 20 00 34 00 DC C2 8C C9 20 00 31 00 04 C7 20 00 10 AC AC C0 69 D5 C8 B2 E4 B2 20 00 20 00 21 00 21 00 21 00 21 00 20 00 00 04 14 39 09 00 30 06 00 00 06 00 00 00 52 00 55 00 4E 00 6E 00 47 00 4F 00 05 78 00 00 00 FF FF FF FF E1 85 00 00 C0 C6 2D 00 65 01 00 00 06 00 00 00 52 00 6E 00 47 00 C4 C9 4F 00 6C 00 35 00 00 00 D0 A9 B1 4E 68 00 00 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 68 00 74 00 74 00 70 00 73 00 3A 00 2F 00 2F 00 63 00 61 00 66 00 65 00 2E 00 6E 00 61 00 76 00 65 00 72 00 2E 00 63 00 6F 00 6D 00 2F 00 73 00 70 00 65 00 65 00 64 00 72 00 6E 00 67 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 20 00 32 00 30 00 30 00 35 00 2E 00 30 00 35 00 2E 00 32 00 32 00 00 04 FE 8D 05 00 01");
                            this.Parent.Client.Send(outPacket);
                        }
                        return;
                    }
